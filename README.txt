...
6. Проверка конфига на наличие определенных настроек ( checkConfig() ):
    Настройка td (добавление нужных и удаление лишних адресов)
    Включение snmpd
    Выключение webcfg
    Установка mint rf4.0 -mode
    Установка mint rf4.0 -airupdate
    ...
    Замена "_" в имени на "-"
    Прописывание qm правил в соответствии со скоростями из биллинга UTM5*
